        ...
        <div className="grid md:grid-cols-3 gap-6">
          {contactMethods.map((method, i) => (
            <motion.div
              ...
              className="group bg-white/80 backdrop-blur-md p-8 rounded-[32px] border border-white shadow-xl shadow-stone-200/50 hover:-translate-y-2 transition-transform duration-500 cursor-pointer focus:outline-none focus:ring-2 focus:ring-rose-300"
            >
              ...
              <div className="space-y-8 relative z-10">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="leading-relaxed">{LOCATION_LINE_1}<br />{LOCATION_LINE_2}</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <div className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center shrink-0">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <p className="font-bold text-sm uppercase tracking-wider text-white/40 mb-1">Email</p>
                    <a className="leading-relaxed underline underline-offset-4 decoration-white/20 hover:decoration-white/60 transition-colors" href={`mailto:${CONTACT_EMAIL}`}>
                      {CONTACT_EMAIL}
                    </a>
                  </div>
                </div>
