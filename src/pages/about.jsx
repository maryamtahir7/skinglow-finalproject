...
export default function AboutPage() {
  ...
  const features = [
    {
      ...
      description:
        "Handpicked items across fashion, electronics, and home essentials with quality guaranteed.",
    ...
    },
    {
      ...
      description:
        "Multiple secure payment gateways including mobile wallets and installment plans.",
  ...
  const timeline = [
    {
      ...
      title: "The Beginning",
      description:
        "MT Store was founded with a vision to revolutionize online shopping in Pakistan.",
    },
    {
      year: "2023",
      title: "Rapid Growth",
    ...
    },
    {
      ...
      description:
        "Launched mobile app and introduced AI-powered personalized shopping experience.",
    },
    {
      year: "2025",
      title: "Market Leader",
      description:
        "Became one of Pakistan's most trusted e-commerce platforms with 4.9 star rating.",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <section
        className="relative overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white"
        data-section
      >
            ...
            >
              <div className="inline-flex items-center gap-3 bg-white/10 backdrop-blur-md rounded-full px-6 py-3 mb-8 border border-white/20">
                ...
                <span className="text-sm font-medium">
                  Pakistan's Most Trusted E-commerce Platform
                </span>
              </div>
              ...
              <p className="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed max-w-3xl mx-auto">
                Revolutionizing e-commerce in Pakistan with innovation, trust, and exceptional
                customer experience
              </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              ...
              quality products with an unmatched shopping experience.
            </p>
          </div>
            ...
            <div className="space-y-8">
              <div className="relative">
                ...
                <blockquote className="text-lg text-gray-700 italic pl-8">
                  "Our mission is to make online shopping not just convenient, but delightful. Every
                  interaction should leave our customers feeling valued and satisfied."
                </blockquote>
